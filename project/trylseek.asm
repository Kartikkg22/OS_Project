...
_trylseek:     file format elf32-i386
...
int main() {
  ...
  12:	68 02 02 00 00       	push   $0x202
  17:	68 18 07 00 00       	push   $0x718
  1c:	e8 e2 02 00 00       	call   303 <open>
    if (fd < 0) {
 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 44 07 00 00 	jmp    *0x744(,%eax,4)
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 3d 07 00 00       	mov    $0x73d,%ebx
